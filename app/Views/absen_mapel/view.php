	...
	<div class="col-xl-12 ui-sortable">
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1" style="" data-init="true">
			...
			<div class="panel-body">
				...
				<form action="<?= base_url() ?>absen_mapel/laporan_mapel/<?= $set_mapel_id ?>" method="GET" target="_blank">
				...
				<body style="min-height: 1100px;">
					<div class="text-center">
						...
						<?php $namaMapel = $this->db->query("SELECT * from sett_mapel
						...
						where sett_mapel_id=$set_mapel_id")->row();
						?>

						<h3>Laporan Absen Mapel <?= $namaMapel->nama_mapel ?> , Kelas <?= $namaMapel->nama_kelas ?>, Pengajar <?= $namaMapel->nama_guru ?></h3>
						<div style="padding-left: 50px; padding-top:30px; padding-bottom:30px;">
							<table class="table table-bordered table-sm">
								<thead>
									<?php $tanggal =  $this->db->query("SELECT * from absen_mapel where set_mapel_id=$set_mapel_id GROUP BY tanggal");
									...
									<tr>
										...
										<?php foreach ($tanggalData as $value) { ?>
											...
											<td style="width: 2%;"><?= $value->tanggal ?></td>
										<?php }  ?>
