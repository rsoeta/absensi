...
<div id="content" class="app-content">
	<div class="panel panel-inverse">
		<div class="panel-heading">
			<h4 class="panel-title">REKAP ABSEN PEGAWAI</h4>
		</div>
		<div class="panel-body bg-white text-dark">
			...
			<div class="text-center" style="min-height: 800px;">
				...
				<h4 class="my-4">
					Laporan Absen <?= ($user_id == 'semua_data') ? "Semua Pegawai" : nama_pegawai($user_id) ?> <br>
				...
				<div class="table-responsive px-4">
					...
					<table class="table table-bordered table-sm text-dark align-middle border-dark text-center">
						<thead class="bg-light fw-bold">
							<tr>
								<td rowspan="2" class="align-middle">Nama Pegawai</td>
						...
						<tbody>
							<?php if ($user_id == 'semua_data') : ?>
								...
								foreach ($query as $data) : ?>
									<tr>
										<td class="text-start"><?= nama_pegawai($data->user_id) ?></td>
										<?php for ($x = 1; $x <= $hari; $x++) : ?>
							...
							<?php else : ?>
								<tr>
									<td class="text-start"><?= nama_pegawai($user_id) ?></td>
									<?php for ($x = 1; $x <= $hari; $x++) : ?>
