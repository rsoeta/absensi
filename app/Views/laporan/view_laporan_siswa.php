	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body bg-white text-dark">
			...
			<div class="text-center" style="min-height: 800px;">
				...
				<h4 class="my-4">
					Laporan Absen <?= ($user_id == 'semua_data') ? "Semua Siswa" : nama_siswa($user_id) ?> <br>
						...
						<tbody>
							<?php if ($user_id == 'semua_data') : ?>
								...
								foreach ($query as $data) : ?>
									<tr>
										<td class="text-start"><?= nama_siswa($data->user_id) ?></td>
										<?php for ($x = 1; $x <= $hari; $x++) : ?>
							...
							<?php else : ?>
								<tr>
									<td class="text-start"><?= nama_siswa($user_id) ?></td>
									<?php for ($x = 1; $x <= $hari; $x++) : ?>
