            ...
            <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
                <div class="menu">
                    ...
                    <div class="menu-item has-sub <?= url_is('guru*') || url_is('pegawai*') || url_is('siswa*') ? 'active' : '' ?>">
                        ...
                        <div class="menu-submenu">
                            <div class="menu-item <?= url_is('guru*') ? 'active' : '' ?>">
                                <a href="<?= base_url('guru') ?>" class="menu-link">
                                    <div class="menu-text">Guru</div>
                                </a>
                            </div>
                            <div class="menu-item <?= url_is('pegawai*') ? 'active' : '' ?>">
                                <a href="<?= base_url('pegawai') ?>" class="menu-link">
                                    <div class="menu-text">Pegawai</div>
                                </a>
                            </div>

                            <!-- SUBMENU SISWA BERGERBANG -->
                            <div class="menu-item has-sub <?= url_is('siswa*') ? 'active' : '' ?>">
                                <a href="javascript:;" class="menu-link">
                                    <div class="menu-text">Siswa</div>
                                    <div class="menu-caret"></div>
                                </a>
                                <div class="menu-submenu">
                                    <!-- Daftar Kelas (Siswa per Kelas) -->
                                    <div class="menu-item <?= url_is('siswa') || url_is('siswa/view/*') ? 'active' : '' ?>">
                                        <a href="<?= base_url('siswa') ?>" class="menu-link">
                                            <div class="menu-text">Daftar Kelas</div>
                                        </a>
                                    </div>
                                    <!-- Daftar Semua Siswa (Gabungan) -->
                                    <div class="menu-item <?= url_is('siswa/semua_siswa') ? 'active' : '' ?>">
                                        <a href="<?= base_url('siswa/semua_siswa') ?>" class="menu-link">
                                            <div class="menu-text">Semua Siswa</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
