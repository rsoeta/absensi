...
<head>
	<meta charset='UTF-8'>
	<title>Cetak Kartu Pegawai Massal</title>
...
<body onload='window.print()' style="font-size: 12px;margin-top:0;position:absolute;">
	<?php foreach ($siswa as $s) : ?>
		<div class="card border" style="width: 30rem; float:left; margin:10px; padding:10px">
			...
			<p style="margin-top: 30px; right:30px; position: absolute; font-family: Cambria; font-size: 25px;"><strong>KARTU PEGAWAI</strong></p>
			<table style="margin-top: 110px; position: absolute; right:130px; text-align: right; font-family: Cambria; font-size: 12px;">
				...
				<tr>
					<td><strong style="font-size: 12px;"><?= $s->nama_pegawai ?></strong></td>
				</tr>
				<tr>
			...
			<img style="border: 1px solid #ffffff;position: absolute;right: 30px;margin-top: 115px; object-fit:cover;" src="<?= base_url('assets/img/pegawai/' . $foto_tampil) ?>" width="85px" height="100px">
			<img style="position: absolute;margin-left: 60px;margin-top: 125px;" src="<?= base_url('assets/img/qr/pegawai/' . $s->qr_code) ?>" width="120px" height="120px">
