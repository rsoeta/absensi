...
<head>
    ...
    <title>Download Kartu - <?= $siswa->nama_siswa ?></title>
    ...
    <script>
        window.onload = function() {
            ...
            Swal.fire({
                ...
                text: 'Mempersiapkan Kartu Siswa Resolusi Tinggi',
            ...
            setTimeout(function() {
                ...
                html2canvas(element, {
                    ...
                    link.download = 'Kartu_Siswa_<?= str_replace(" ", "_", $siswa->nama_siswa) ?>_<?= $siswa->nisn ?>.png';
                    link.href = imgData;
